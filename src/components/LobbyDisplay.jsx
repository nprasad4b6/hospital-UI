  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans">
      ...
      <div className="bg-white border-b border-slate-200 p-3 sticky top-0 z-10 flex justify-between items-center shadow-sm">
        ...
        <button
          onClick={handleReset}
          className="bg-blue-600 text-white px-4 py-1 rounded-full text-sm font-bold"
        >
          RESET
        </button>
      </div>
        ...
        <div className="mt-8">
          ...
          <div className="space-y-3">
            {queueList.map((patient) => (
              <div
                key={patient.token}
                className="flex items-center justify-between bg-white p-4 rounded-2xl border border-slate-200 shadow-sm transition-all active:scale-95"
              >
